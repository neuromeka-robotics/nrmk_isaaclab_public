...
class NamySceneCfg(InteractiveSceneCfg):
    ...
    camera_front = TiledCameraCfg(
        ...
        offset=TiledCameraCfg.OffsetCfg(pos=(0.1080, 0.0, 0.2332), rot=(0.9848078, 0., 0.1736482, 0.), convention="world"),
...
class ObservationsCfg:#
    ...
    class RobotStatesCfg(ObsGroup):
        ...
        qdot = ObsTerm(
            func=mdp.finite_joint_vel, params={"asset_cfg": SceneEntityCfg("robot")})
        p = ObsTerm(
            func=mdp.position_in_world, params={"body_name": "base_link"})
        base_vel = ObsTerm(
